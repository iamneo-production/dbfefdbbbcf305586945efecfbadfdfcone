...
class SpringappApplicationTests {
	...
	void testadd() throws Exception {
		...
		String st = "{\"languageId\": 100, \"languageName\": \"English\", \"languageComplexity\": \"Avg\"}";
    ...
    void testgetByID() throws Exception{
	 ...
	 void testupdateDetails() throws Exception {  
		...
		String st ="{\"languageId\": 100, \"languageName\": \"Russian\", \"languageComplexity\": \"Avg\"}";
		   ...
		   mockMvc.perform(MockMvcRequestBuilders.put("/1001")
						 ...
						 .andExpect(jsonPath("$.languageName").value("Russian"))
    ...
    void testdeleteById() throws Exception{
         ...
         mockMvc.perform(MockMvcRequestBuilders.delete("/100")
    ...
    public void controllerfile() {
        ...
        String filePath = "src/main/java/com/examly/springapp/controller/LanguageController.java";
    ...
    public void testModelFile() {
        ...
        String filePath = "src/main/java/com/examly/springapp/model/Language.java";
    ...
    public void testrepositoryFile() {
        ...
        String filePath = "src/main/java/com/examly/springapp/repository/LanguageRepo.java";
